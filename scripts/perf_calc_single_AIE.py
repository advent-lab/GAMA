...
filename = project_dir + "/output0.txt"
...
Latency = mean(global_diff_list)*1e-9
print("File tlast list:", file_tlast_list)
print("File diff list:", file_diff_list)
print("Global diff list:", global_diff_list)
Throughput = 2*(single_M)*(single_K)*(single_N) / mean(global_diff_list)


print("")
print("Matrix size:", single_M, "x", single_K, "x", single_N)

if (precision == "int8"):
    print("Precision: int8")
    print(f"Latency: {Latency:.4e} s")
